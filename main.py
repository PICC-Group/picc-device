...
# Then depending on if DATA_FILE is False, either playback mode is used or streaming directly from the nanoVNA. 
async def main():
    ...
    async_data_stream = AsyncDataProcessor(simulate=False, datafile=False, producer_sleep_time=0.1, process_sleep_time=0.0001, verbose=False)
